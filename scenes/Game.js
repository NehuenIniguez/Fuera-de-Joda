export default class Game extends Phaser.Scene {
  ...
  create() {
    ...
    //globo de texto
    this.globoTexto = this.add.image(
      this.personaje.x + 300,
      this.personaje.y - 250,
      "globo"
    );
    ...
    this.dialoge = [
      ...
      "¿Por qué estas hablando con esa zapatilla? Porque dice Converse",
    ...
    this.Text = this.add.text(
      this.personaje.x + 120,
      this.personaje.y - 320,
      ` ${chiste} `,
      {
        fontSize: "25px Arial",
        fill: "#000",
    ...
    this.textScore = this.add
      ...
      .setOrigin(1, 0);
    this.repeatOn = 900;
    this.eventRecolect = this.time.addEvent({
      delay: this.repeatOn,
    ...
    this.time.addEvent({
      delay: 5000,
      callback: this.AumentaVelocidad,
      callbackScope: this,
      loop: true,
    });
